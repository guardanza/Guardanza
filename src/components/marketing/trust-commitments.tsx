...
const COMMITMENTS: { icon: typeof BookLock; title: string; description: string }[] = [
  ...
  { icon: Flag, title: "Pensado para Chile", description: "En español, con RUT, UF y el flujo real del arriendo chileno." },
];
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {COMMITMENTS.map((c) => (
          <div key={c.title} className="rounded-xl border border-border p-4 text-center">
            <c.icon className="mx-auto size-6 text-brand-gold" strokeWidth={2} />
