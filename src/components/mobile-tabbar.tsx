...
// These 5 are Dashboard + the three CARTERA items, in the same order as
// the CARTERA group in the desktop sidebar — everything else (OPERACIÓN,
// CUENTA) lives behind "Más", grouped the same way there.
